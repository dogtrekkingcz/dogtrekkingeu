...
class PetTypesAdapter(private val context: Context, private val arrayList: java.util.ArrayList<PetTypeDto>) : ArrayAdapter<PetTypeDto>(context, 0, arrayList) {
    ...
    override fun getItem(position: Int): PetTypeDto {
