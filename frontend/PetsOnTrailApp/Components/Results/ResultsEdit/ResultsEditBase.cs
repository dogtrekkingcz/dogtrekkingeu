...
namespace PetsOnTrailApp.Components.Results.ResultsEdit;

public class ResultsEditBase : ComponentBase
{
    ...
    protected void CheckpointPassed(Guid checkpointId, ChangeEventArgs args)
    {
        var checkpoint = Model.Checkpoints.FirstOrDefault(checkpoint => checkpoint.Id == checkpointId);
        if (checkpoint != null)
        {
