...
public sealed class NewActionRegistrationPaymentReceivedEmailBuilder : IEmailBuilder
{
    ...
    public string Subject => $@"[{_request.Action.Name}][{_request.Racer.Surname}, {_request.Racer.Name} - {_request.Amount},-] {_localize["NewActionRegistrationPayment.Emails.NewRegistrationPaymentReceived"]}";
    ...
    public string Body => $@"
        <div>
            ...
            <table>
                <tr>
                    <td><b>{_localize["NewActionRegistrationPayment.Emails.NameSurname"]}</b></td><td>{_request.Racer.Name}, {_request.Racer.Surname}</td>
                </tr>
                <tr>
